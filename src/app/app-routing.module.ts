...
import {CronogramapComponent} from './cronogramap/cronogramap.component';
import {ViewTableComponent} from './cronogramap/view-table/view-table.component';
...
const routes: Routes = [
  ...
  {
    path : 'addCronograma',
      component : CronogramapComponent,
  },
  {
    path : 'viewTable',
